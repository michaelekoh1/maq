...
const question = [
    {
      question: "images/Alicia Keys.jpeg",
      answers: [
    ...
    {
      question: "images/Bruno Mars.jpg",
      answers: [
    ...
    {
      question: "images/Dolly Parton.jpeg",
      answers: [
        { text: "Reba McEntire", correct: false },
    ...
    {
      question: "images/Johnny cash.jpeg",
      answers: [
        { text: "Willie Nelson", correct: false },
    ...
    {
      question: "images/Kelly Clarkson.jpeg",
      answers: [
    ...
    {
      question: "images/Kenny Rogers.png",
      answers: [
        { text: "Johnny Cash", correct: false },
        { text: "Eminem", correct: false },
    ...
    {
      question: "images/Lil Wayne.jpeg",
      answers: [
    ...
    {
      question: "images/Reba McEntire.jpeg",
      answers: [
        { text: "Alicia Keys", correct: false },
    ...
    {
      question: "images/Willie Nelson.jpeg",
      answers: [
  ...
  function start(){
      ...
      document.body.style.backgroundImage='url(images/hero-bg.jpg)';
      if(name!=""){
          username = name;
      }
      else{
  ...
  // This function saves the user score in the local storage
  ...
  // This function builds elements for the high scores where top 5 scores are displayed in descending order
